  ...
  <thead>
     <tr id="fila1" style="background-color:#e8e8e8;">
                 <th style="text-align:center; ">Nº #</th>
                  ...
                  <th style="text-align:center; ">Precio Venta Bs.</th>     
...
while ($fila = mysqli_fetch_object($resultado)) {
   ...
   $montoDecimal =$montoInvent;// number_format((float)$montoInvent, 2, '.', '');
   $precio_unit_compraDecima=ajustarDecimales($fila->precio_unit_compra);//number_format($fila->precio_unit_compra, 2, '.', ',');

   $valorMontoAjusteDecimal=ajustarDecimales($montoDecimal);
   $bloqueDatosDetalle = <<<EOF
                                  ...
                                  <th style="text-align:center; ">$contador</th>
                                     ...
                                     <th style="text-align:right; ">$fila->stock_actual</th>
                                     
                                     <th style="text-align:right; ">$fila->precio_venta_prod</th>
                                     <th style="text-align:right; ">$precio_unit_compraDecima</th>
                                     <th style="text-align:right;">$valorMontoAjusteDecimal</th>                                
                                  </tr>
                                  </thead>
                                  </table>
                                  EOF;
...
$totalSaldoInventarioDecimal = number_format((float)$totalSaldoInventario, 2, '.', '');
$bloqueTotalesCostosOrdenes = <<<EOF
<table border="0.1px" cellpadding="1" >
<tr style="page-break-inside: avoid;" nobr="true">
   <td style="text-align:center; width:501px;">TOTAL EN INVENTARIO</td>
   <td style="text-align:right; width:72px;">$totalSaldoInventarioDecimal</td>
