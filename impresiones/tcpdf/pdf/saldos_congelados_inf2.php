...
$abogadonombre=$datos['nombreusuario'];
        ...
        $pdf->Cell(250, 0, '                                                                                       IMPRESION DE SALDOS DE CLIENTES EN CAUSAS CONGELADAS', 0, 0, 'C', 0, '', 0);
...
$pdf->writeHTML($bloque1,false,false,false,false,'');
  ...
  $objcausa=new Causa();
  $resulcausa=$objcausa->mostrarInforme_2saldoscongeladas();
