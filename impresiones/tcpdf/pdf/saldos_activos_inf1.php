...
/*===============================================================
TAMAÑO TOTAL DE LA HOJA OFICIO ECHADA(ORIZONTAL)=905px DISPONIBLE PARA OCUPAR CON DATOS, RESPETANDO LOSMARGENES ESTABLECIDOS POR CODIGO EN LA FUNCION ->SetMargins(34, 30 ,30)
/*===============================================================*/
...
$nombre=$datos['nombreusuario'];
        ...
        $pdf->Cell(85, 0, 'Usuario: '.$nombre, 0, 1, 'R', 0, '', 1);
...
<table border="0.1px">
	<thead>
	   <tr>
		...
		<th style="text-align:center;  width:35px;  background-color:#e8e8e8;">SALDO</th>
		<th style="text-align:center;  width:295px; background-color:#e8e8e8;">OBSERVACIONES</th>
		</tr>
	</thead>
</table>
EOF;
