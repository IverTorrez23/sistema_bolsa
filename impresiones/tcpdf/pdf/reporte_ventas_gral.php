...
$pdf->Ln(10);
$pdf->Cell(100, 0, '                                                                                       REPORTE GENERAL DE VENTAS EN EL RANGO DE FECHAS', 0, 0, 'C', 0, '', 0);
$pdf->Ln(4);
...
<table border="0.1px">
  <thead>
     <tr id="fila1" style="background-color:#e8e8e8;">
                  ...
                  <th style="text-align:center; ">Venta credito</th>
...
$imgRuta = ($fila->venta_credito == 1) ? './images/only-check.png' : './images/cercle-gris.png';
...
$htmlIconoCancelado = '<img src="' . $imgRutaCan . '" width="8" height="6" />';
    ...
    $bloqueDatosDetalle = <<<EOF
                                  ...
                                  <tr style="page-break-inside: avoid; " nobr="true">
                                     <th style="text-align:center; ">$fila->idventa</th>
                                     <th style="text-align:center; ">$fila->fecha_venta</th>
                                     <th style="text-align:center; ">$fila->nameCliente</th>
                                     ...
                                     <th style="text-align:center; ">$fila->monto_venta</th>                               
                                  </tr>
                                  </thead>
                                  </table>
                                  EOF;
...
/***************************TABLA TOTALES*************/
$totalMontoVentasDecimal = number_format((float)$totalMontoVentas, 2, '.', '');

$bloqueTotalesCostosOrdenes = <<<EOF
<table border="0.1px" cellpadding="1" >
<tr style="page-break-inside: avoid;" nobr="true">
   <td style="text-align:center; width:490px;">TOTALES</td>
   <td style="text-align:center; width:83px;">$totalMontoVentasDecimal</td>
</tr>
...
$nameFile = 'reporte_venta_gral.pdf';
