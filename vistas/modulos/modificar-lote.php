...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Modificacion
            <small>Lote: <?php echo $idCompraProducto; ?> </small>
        </h1>
        <input type="hidden" value="<?php echo $idCompraProducto; ?>" placeholder="id compra">

        
            <form action="modificar-lote" method="GET" style="display: flex; gap: 5px;">
                <input type="number" name="lote" placeholder="N° de lote..." required style="padding: 4px 8px; border: 1px solid #ccc; border-radius: 4px; width: 120px;">
            ...
            <div class="box-body">
                <table class="table table-bordered table-striped ">
                    ...
                    <tbody>
                        ...
                        $resultado = $obj->mostrarUnLote($idCompraProducto);
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>Costo Total de Compra de este producto</label>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-check"></i></span>
