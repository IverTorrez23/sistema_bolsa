          ...
          <table class="table table-bordered table-striped tablas tablaProductos">
             ...
             <tbody>
               ...
               $contador=1;
                ...
                $resultado=$obj->listarProductosParaVenta();
...
// CARGAMOS EL ID DEL PRODUCTO AL ARRAYDE PRODUCTOS SELECCIONADOS
  ...
  '<!--producto-->'+
     ...
     '<td><button class="btn btn-danger btn-xs quitarProducto" idcompraprod="'+id+'">Eliminar</button></td>'+
...
/*============================================================
 ...
 //  console.log(arrayIdproductosVenta); 
   ...
   $("button.recuperarBoton[data-id='"+idcompraprod+"']").addClass('btn-success ');
