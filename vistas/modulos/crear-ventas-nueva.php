...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <!-- /.row -->
     ...
     Cuota: <input type="text" id="cuotaVenta" name="cuotaVenta" style="float: right;" autocomplete="off">
     </div><br><br>
...
<script type="text/javascript">
  ...
  $("#checkVentCred").on("change", function() {
    $("#cuotaCompra").val(0);
    if ($(this).is(":checked")) {
    ...
    $("#btnguardarventa").on('click', async function() {
      ...
      if ((totaldeprodventa < 0)) {
        ...
        if (Cheq1 == false) /*preguntamos si esta chequeado venta facturada, por verdadero, osea no es venta facturada*/ {
          ...
          var idprodcompra = comprobarPrecioCorectoEnVenta();
          /*llamamos a la funcion que conprueba que los precios de venta esten 
                                correctos*/
          ...
          if (Cheq1 == true) {
            ...
            switchfactura = "si";
            var idprodcompra = comprobarPrecioCorectoEnVentaFacturada();
            /*llamamos a la funcion que conprueba que los precios de venta esten 
                                  correctos*/
            /*TRAEMOS LOS DATOS DEL ID COMPRA PARA DAR LA ALERTA QUE LOS PRECIOS DE VENTA ESTAN FUERA DE COSTOS*/
            if (idprodcompra > 0) {
        ...
        var checkVentCred = document.getElementById("checkVentCred").checked
        if (checkVentCred == true) {
          switchCredit = 1;
          //Destikeamos el checkbox
          const checkbox = document.getElementById('checkVentCred');
          ...
          success: function(response) {
            ...
            if (response > 0) {
              ...
              while (contadorid < totaldeprodventa) {
                ...
                $.ajax({
                  url: 'controladores/ventaProducto.controlador.php',
                  type: 'post',
