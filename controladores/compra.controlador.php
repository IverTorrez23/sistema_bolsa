...
function ctrlEditarCompra()
{
	...
	if ($filvent->cantidad_ventas > 0) {
		...
		$subTotalViejo = $_POST["subTotalViejo"];
		$nuevoTotalCompraSinSubProd = $totalMontocompra - $subTotalViejo;

		$costoSubTotalcompraedit = $_POST["costoSubTotalcompraedit"];
		$nuevoTotalCompraConSubProdEdit = $nuevoTotalCompraSinSubProd + $costoSubTotalcompraedit;

		$objcomedit = new Compra();
		$objcomedit->set_montoCompra($nuevoTotalCompraConSubProdEdit);
